...
//                        var contador by remember { mutableIntStateOf(0) }
                        ...
                        ContadorStateless(contador, onIncrementContador = {viewModel.incrementar()}, onDecrementoContador = {viewModel.decrementar()}, modifier = Modifier.padding(innerPadding))
                        ContadorStateless(contador, onIncrementContador = {viewModel.incrementar()}, onDecrementoContador = {viewModel.decrementar()},modifier = Modifier.padding(innerPadding))
                    }
                }
            }
